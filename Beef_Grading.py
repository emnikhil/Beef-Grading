...
in_file = 'F:/Machine Learning Projects/Beef Grading/63-0713.jpg'
out_file = 'F:/Machine Learning Projects/Beef Grading/7.jpg' 
...
img = np.asarray(Image.open('F:/Beef Images/6.jpg').convert('L')) #read and convert image
